...
if __name__ == "__main__":
    ...
    for i in range(demo.shape[0]):
        ...
        filename_full = '/home/jwlee/HMM/ST_GCN/data/HCP_1200/hcp_tc_npy_22/'+subject_string+'_cortex.npy'
    ...
    np.save('/home/jwlee/HMM/ST_GCN/data/adj_matrix.npy', A)
    ...
    for train_idx, test_idx in skf.split(data, label):
        ...
        filename = '/home/jwlee/HMM/ST_GCN/data/train_data_'+str(fold)+'.npy'
        np.save(filename,train_data)
        filename = '/home/jwlee/HMM/ST_GCN/data/train_label_'+str(fold)+'.npy'
        np.save(filename,train_label)
        filename = '/home/jwlee/HMM/ST_GCN/data/test_data_'+str(fold)+'.npy'
        np.save(filename,test_data)
        filename = '/home/jwlee/HMM/ST_GCN/data/test_label_'+str(fold)+'.npy'
