...
def dataloader(args, fold, train=True, config=None, phase=None):
    ...
    if train:
        ...
        train_signal_list = np.array(train_signal_list)  # (960, 140, 200)
        valid_signal_list = np.array(valid_signal_list)  # (320, 140, 200)
        tst_signal = np.array(test_signal_list)  # (321,)
