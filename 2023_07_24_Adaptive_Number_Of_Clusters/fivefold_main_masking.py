...
import numpy as np
from dataset import *
from main_model_masking import *
...
if __name__=='__main__':
    ...
    def get_arguments():
        ...
        parser.add_argument('-n', '--exp_name', type=str, default='experiment_3')
        ...
        parser.add_argument('-dt', '--targetdir', type=str, default='/DataCommon2/jwlee/2023_07_24_Adaptive_Number_Of_Clusters/masking_FC_10/result')
