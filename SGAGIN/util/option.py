...
def parse():
    ...
    parser.add_argument('-n', '--exp_name', type=str, default='stagin_experiment2_07_24')
    parser.add_argument('-k', '--k_fold', type=int, default=5)
    parser.add_argument('-b', '--minibatch_size', type=int, default=2)
    ...
    parser.add_argument('--roi', type=str, default='destrieux', choices=['scahefer', 'aal', 'destrieux', 'harvard_oxford'])
