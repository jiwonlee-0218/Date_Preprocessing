...
import os
import numpy as np
from cluster_2_main_config import get_arguments
from cluster_2_models import ClusterNet, TAE
...
####################################################
    ...
    ''' motor '''
    list_atlas = [36, 78, 99, 162, 183, 225, 246]
    ...
    cluster_2_sample = arr   # (1080, 136, 116)
#####################################################
    ...
    cluster_2_label = label_list_RL   # (1080, 136)
#####################################################
    ...
    X_train, X_test, y_train, y_test = train_test_split(cluster_2_sample, cluster_2_label, random_state=42, test_size=0.2)
