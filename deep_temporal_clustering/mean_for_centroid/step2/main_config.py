...
def get_arguments():
    ...
    # model args
    parser.add_argument("--model_name", default="new_Autoencoder_onedir_LSTM32_kl+mse",help="model name")
    ...
    parser.add_argument("--dir_root", default='/home/jwlee/HMM/deep_temporal_clustering/mean_for_centroid/step2',)
