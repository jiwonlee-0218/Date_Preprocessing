...
from MAE_fMRI_train import *
import MAE_fMRI_clusternet
import MAE_fMRI_vision_transformer as vits
...
def get_args_parser():
    ...
    parser.add_argument("--model_name", default="30pre_real_masked_test_30_plz", help="model name")
    ...
    # directory
    parser.add_argument("--dir_root", default='/home/jwlee/HMM/deep_temporal_clustering/mean_for_centroid/real_MAE/', )
...
if __name__ == '__main__':
    ...
    if args.weights is not None and args.SiT_models is None and args.SiT_test is None:  #### weight ok, but model is none
        ...
        full_path = '/home/jwlee/HMM/deep_temporal_clustering/mean_for_centroid/real_MAE/real_masked_test_70_plz/MOTOR/Epochs150_BS_16_LR_0.001_wdcay_1e-06/models_weights/checkpoint_epoch_30_loss_0.02209.pt'
        print("I got: " + full_path + " weights")
        ...
        DTC_model = MAE_fMRI_clusternet.ClusterNet(args, Full_SiT_model)
        DTC_model = DTC_model.to(args.device)
