...
def get_arguments():
    ...
    # model args
    parser.add_argument("--model_name", default="Autoencoder_1CONV1D80_testnnnnnnnnnnnnnnnnnnnnnnnn",help="model name")

    # training args
    parser.add_argument("--gpu_id", type=str, default="0", help="GPU id")

    parser.add_argument("--batch_size", default=8, type=int, help="batch size")
    parser.add_argument("--epochs_ae", type=int, default=400, help="Epochs number of the autoencoder training",)
    ...
    parser.add_argument("--dir_root", default='/home/jwlee/HMM/deep_temporal_clustering/',)
    parser.add_argument("--init_weights", default=True, type=bool)

    # parser.add_argument("--ae_weights", default='models_weights/', help='pre-trained autoencoder weights')
    parser.add_argument("--ae_weights", default=None, help='pre-trained autoencoder weights')
    parser.add_argument("--ae_models", default='models_picture/', help='pre-trained autoencoder weights')
