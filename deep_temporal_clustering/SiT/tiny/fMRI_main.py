...
def get_args_parser():
    ...
    parser.add_argument("--model_name", default="SiT_tiny", help="model name")
...
class FullpiplineSiT(nn.Module):
    ...
    def forward(self, im):
        ...
        encoded_out = self.backbone(im) # torch.Size([8, 284, 116]) -> torch.Size([8, 286, 80])
        represent = encoded_out[:, 2:]
