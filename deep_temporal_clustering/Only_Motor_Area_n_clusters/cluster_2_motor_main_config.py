...
def get_arguments():
    ...
    # model args
    parser.add_argument("--model_name", default="new_Autoencoder_onedir_LSTM7",help="model name")
    ...
    parser.add_argument("--max_epochs",type=int, default=50, help="Maximum epochs numer of the full model training",)
    ...
    parser.add_argument("--dir_root", default='/home/jwlee/HMM/deep_temporal_clustering/Only_Motor_Area_n_clusters',)
