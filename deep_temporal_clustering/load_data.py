...
def load_data(dataset_names, all_ucr_datasets, scale=True):
    """
    args :
    ...
    """
    if dataset_names in all_ucr_datasets:
        return load_ucr(dataset_names, scale)
    else:
        print(
...
def get_loader(args):
    ...
    X_scaled, y = load_data(args.dataset_names, all_ucr_datasets)
    # create dataset
