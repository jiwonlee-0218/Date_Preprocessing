...
def get_arguments():
    ...
    # model args
    parser.add_argument("--model_name", default="DTCR_bidirection_dilated_RNN",help="model name")
    ...
    parser.add_argument("--dir_root", default='/home/jwlee/HMM/deep_temporal_clustering/DTCR_application/add_real_fake_classification_task',)
