...
def get_arguments():
    ...
    # data args
    parser.add_argument("--dataset_name", default="EMOTION_no_positionalencoding_no_kmeansloss_newttttttttttttttttttttttttttttttt", help="dataset name")

    # model args
    parser.add_argument("--model_name", default="Transformer",help="model name")
    ...
    parser.add_argument("--epochs_ae", type=int, default=421, help="Epochs number of the autoencoder training",)
