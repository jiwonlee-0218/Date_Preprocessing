...
def get_arguments():
    ...
    # data args
    parser.add_argument("--dataset_name", default="EMOTION_CNN", help="dataset name")
    ...
    parser.add_argument("--dir_root", default='/home/jwlee/HMM/deep_temporal_clustering/DTCR_application/add_real_fake_classification_and_kmeansloss',)
