...
data_path = '/mnt/hcp/homes/jwlee/HCP_train_data/tfMRI_MOTOR_LR/4d/ho/'
...
data_path2 = '/mnt/hcp/homes/jwlee/HCP_train_data/tfMRI_MOTOR_RL/4d/ho/'
...
split_task_only_LR()
split_task_only_RL()
np.savez_compressed('/media/12T/practice/LR_DICT/hcp_motor_ho_label', label_list_LR=split_task_only_LR(), label_list_RL=split_task_only_RL())
