...
if __name__ == '__main__':
    ...
    augment_ASD_feats, augment_ASD_labels, augment_ASD_pheno, sk_data, sk_label = data_augment(ASD_feats, ASD_labels, ASD_pheno, crops)
    ...
    for i_count in range(CV_count):
        ...
        for train_index, test_index in kf.split(sk_data, sk_label):
            ...
            model.fit(x=[x_train, x_train_pheno], y=y_train, epochs=30, batch_size=128, validation_split=0.1)
            ...
            for i in range(len(test_index)):
                ...
                ASD_true_subject = y_test[i * crops:i * crops + crops].append(np.sum(ASD_true_subject) / crops)
